...
history = classifier.fit(X, Y, validation_data=(test_x, test_y), epochs=25, batch_size=50, verbose=1)
accuracy = classifier.evaluate(x=test_x,y=test_y,batch_size=8)
print("Accuracy: ",accuracy[1])
classifier.save('CNNmodelv2.h5') #save model for later use, will be called in to program for using webcam and doing live processing
